        ...
        <div class="space-y-6">
          ...
          <div>
            <div class="flex items-center justify-between">
              ...
              <div class="text-sm">
                <a href="/fog" class="font-semibold text-sky-600 hover:text-sky-700">Forgot password?</a>
              </div>
            </div>
            <div class="mt-2">
          ...
          <div>
            <button @click="signInClicked" type="submit"
              class="flex w-full justify-center rounded-md bg-sky-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Sign
              in</button>
          </div>
        </div>
