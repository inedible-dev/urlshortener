  ...
  <div class="bg-gray-900 min-h-screen text-gray-200">
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-200">Create your account</h2>
      </div>
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <div class="space-y-6">
          ...
          <div>
            ...
            <div class="mt-2">
              <input v-model="password" id="password" name="password" type="password" autocomplete="current-password"
                required
                class="block bg-gray-800 px-[10px] w-full rounded-md border-0 py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-700 placeholder:text-gray-200 outline-none sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div>
            <div class="flex items-center justify-between">
              <label for="repeat" class="block text-sm font-medium leading-6">Repeat Password</label>
              <div class="text-sm">
          ...
          <div>
            <button @click="onSignupClicked" type="submit"
              class="flex w-full justify-center rounded-md bg-sky-700 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Create
              new account</button>
            <!-- <button class="flex items-center bg-white border border-gray-300 rounded-lg shadow-sm px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
          ...
          {{ ' ' }}
          <a href="/login" class="font-semibold leading-6 text-sky-600 hover:text-sky-700">Sign In</a>
        </p>
      </div>
    </div>
  </div>
