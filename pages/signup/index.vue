<template>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <div class="space-y-6">
        ...
        <div>
          <div class="flex items-center justify-between">
            <label for="repeat" class="block text-sm font-medium leading-6 text-gray-900">Repeat Password</label>
            <div class="text-sm">
              <!-- <a href="#" class="font-semibold text-sky-600 hover:text-sky-500">Forgot password?</a> -->
            </div>
          </div>
          <div class="mt-2">
            <input v-model="repeat" id="repeat" name="repeat" type="password" autocomplete="current-password" required class="block px-[10px] w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-600 sm:text-sm sm:leading-6" />
          </div>
        </div>

        <div>
          <button @click="onSignupClicked" type="submit" class="flex w-full justify-center rounded-md bg-sky-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">Create new account</button>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        {{ ' ' }}
        <a href="/login" class="font-semibold leading-6 text-sky-600 hover:text-sky-500">Sign In</a>
      </p>
    </div>
  </div>
